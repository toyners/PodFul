...
type FinalisingFileNameFunctions_UnitTests() = 
    ...
    member public this.``Alternate naming algorithm has most successful naming resolutions``() =
        ...
        let podcasts =
            [|
                ...
                Setup.createTestPodcast "title2" "description2" "http://abc.com/episode2/fileName.mp3" FeedFunctions.NoDateTime 2L FeedFunctions.NoDateTime "image2" "imageURL2" String.Empty
                Setup.createTestPodcast "title3" "description3" "http://abc.com/episode3/fileName.mp3" FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL3" String.Empty
                Setup.createTestPodcast "title4" "description4" "http://abc.com/episode/fileName1.mp3" FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL4" String.Empty
                Setup.createTestPodcast "title5" "description4" "http://abc.com/episode/fileName2.mp3" FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL4" String.Empty
    ...
    member public this.``Standard naming algorithm has most successful naming resolutions``() =
        ...
        let expectedFileName1 = feedName + " - title1.mp3"
        let expectedFileName2 = feedName + " - title2.mp3"
        let expectedFileName3 = "fileName1.mp3"
        let expectedFileName4 = "fileName2.mp3"
        let expectedFileName5 = "fileName3.mp3"
        let expectedFileName6 = feedName + " - title6.mp3"
        let expectedFileName7 = String.Empty
        ...
        let podcasts =
            [|
                ...
                Setup.createTestPodcast "title4" "description4" "http://abc.com/episode/fileName2.mp3" FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL4" String.Empty
                Setup.createTestPodcast "title5" "description4" "http://abc.com/episode/fileName3.mp3" FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL4" String.Empty
                Setup.createTestPodcast "title6" "description4" String.Empty FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL4" String.Empty
                Setup.createTestPodcast "title6" "description4" String.Empty FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL4" String.Empty
            |]
    ...
    member public this.``Standard naming algorithm has the same number of resolutions as alternative naming algorithm``() =
        ...
        let expectedFileName4 = "fileName1.mp3"
        let expectedFileName5 = "fileName2.mp3"
        let expectedFileName6 = "fileName3.mp3"
        ...
        let podcasts =
            [|
                ...
                Setup.createTestPodcast "title3" "description3" "http://abc.com/episode3/fileName.mp3" FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL3" String.Empty
                Setup.createTestPodcast "title4" "description4" "http://abc.com/episode/fileName1.mp3" FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL4" String.Empty
                Setup.createTestPodcast "title5" "description5" "http://abc.com/episode/fileName2.mp3" FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL4" String.Empty
                Setup.createTestPodcast "title6" "description6" "http://abc.com/episode/fileName3.mp3" FeedFunctions.NoDateTime 3L FeedFunctions.NoDateTime "image3" "imageURL4" String.Empty
